...
public class CompraStepDefinition {
    ...
    public void ingresa_su_y_en_la_pantalla_de_inicio(String usuario, String contrasena) {
        theActorInTheSpotlight().attemptsTo(
                ...
                Enter.theValue(usuario).into(USERNAME_FIELD),
    ...
    public void se_elige_el_y_para_comprar(String productoUno, String productoDos) {
        ...
        Target agregarProductoUno = Target.the("Producto Uno Add")
                .located(By.xpath(obtenerXpathProducto(productoUno, "Add to cart")));
        Target agregarProductoDos = Target.the("Producto Dos Add")
                .located(By.xpath(obtenerXpathProducto(productoDos, "Add to cart")));
        theActorInTheSpotlight().attemptsTo(
        ...
        Target removerProductoUno = Target.the("Producto Uno Remove")
                .located(By.xpath(obtenerXpathProducto(productoUno, "Remove")));
        Target removerProductoDos = Target.the("Producto Dos Remove")
                .located(By.xpath(obtenerXpathProducto(productoDos, "Remove")));
    ...
    public void se_ingresa_y_del_comprador_se_hace_clic_en_boton_continuar(String nombre, String apellido, String codigoPostal) {
        ...
        theActorInTheSpotlight().attemptsTo(
                ...
                Enter.theValue(apellido).into(PRIMER_APELLIDO),
